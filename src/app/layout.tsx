...
export const metadata: Metadata = {
  ...
  description:
    "Každý den nový motivační citát, který vám pomůže nastartovat den. Inspirujte se a sdílejte moudrost s ostatními.",
  keywords: [
    "citáty",
    "motivace",
    "inspirace",
  ...
  twitter: {
    ...
    title: "Citát Dne | Denní dávka inspirace",
    description:
      "Každý den nový motivační citát, který vám pomůže nastartovat den.",
    images: ["/og-image.png"],
    creator: "@dailyquoteapp",
  },
