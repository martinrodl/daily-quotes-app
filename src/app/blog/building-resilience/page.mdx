...
export const metadata: Metadata = {
  title: "Building Resilience with Motivational Quotes | Daily Quotes Blog",
  description: "How inspirational words can help you overcome challenges and grow stronger. Learn to build mental resilience through daily motivation.",
  openGraph: { title: "Building Resilience with Motivational Quotes", description: "How inspirational words can help you overcome challenges and grow stronger", type: "article", publishedTime: "2024-12-15T00:00:00.000Z" },
}
