...
export const metadata = { title: "Building Resilience with Motivational Quotes | Daily Quotes Blog", description: "How inspirational words can help you overcome challenges and grow stronger." };
