...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Finding Mindfulness Through Ancient Wisdom", description: "Exploring timeless quotes that bring peace and clarity to modern life", type: "article", publishedTime: "2024-12-20T00:00:00.000Z" },
}
