...
export const metadata: Metadata = { title: "Finding Mindfulness Through Ancient Wisdom | Daily Quotes Blog", description: "Exploring timeless quotes that bring peace and clarity to modern life. Ancient wisdom for contemporary mindfulness practice." }
